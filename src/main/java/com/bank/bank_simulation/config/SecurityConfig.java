...
import com.bank.bank_simulation.filters.JwtAuthenticationFilter;
 ...
 * It includes setting up CORS (Cross-Origin Resource Sharing), authentication providers, 
 * and authorization rules to ensure secure access to various parts of the application.
 *
 * @author Wafulah 
 */
